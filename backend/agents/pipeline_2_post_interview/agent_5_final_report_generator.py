...
```json
{
  ...
  "communication_skills": {
    "assessment": "Оценка коммуникационных навыков ИСКЛЮЧИТЕЛЬНО на основе анализа текста. Оцени: 1. Структурированность речи (логическая последовательность в ответах). 2. Полнота ответов (ответил ли кандидат на все части вопроса). 3. Использование профессиональной терминологии (корректно или некорректно)."
  },
  "foreign_languages": {
