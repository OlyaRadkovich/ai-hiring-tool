...
- Текст резюме кандидата (CV). **Этот текст может отсутствовать или содержать сообщение "CV не был предоставлен".**
...
Если CV не предоставлен, основывай **информацию о кандидате** на cписке тем/вопросов интервью и транскрипции, а в полях, требующих данных из CV, укажи, что информация отсутствует.

-   **Для `knowledge_assessment`:** Сопоставь **cписок тем/вопросов интервью** ответы из **транскрипции** и навыки из **CV** с **матрицей компетенций** и **требованиями к вакансии**.
...
```json
{
  ...
  "candidate_info": {
    ...
    "tech_stack": [
      "Список ключевых технологий из CV или транскрипции"
    ],
    "projects": [
      "Краткое описание проектов, в которых участвовал кандидат, из CV или транскрипции"
    ],
    "domains": [
      "Список доменных областей из CV или транскрипции"
    ],
    "tasks": [
        "Список задач, которые кандидат выполнял на проектах, извлеченный из CV или транскрипции."
    ]
  },
  "interview_analysis": {
    "topics": [
