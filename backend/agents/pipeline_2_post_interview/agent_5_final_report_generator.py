...
agent_5_final_report_generator = Agent(
    ...
    instruction="""
Ты — ведущий AI-аналитик в HR-департаменте. Твоя главная задача — провести глубокий сравнительный анализ кандидата, сопоставляя информацию о нем с требованиями компании, и на основе этого анализа сгенерировать исчерпывающий JSON-отчет.
